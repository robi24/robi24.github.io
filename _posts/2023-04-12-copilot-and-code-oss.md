...
last_modified_at: 2025-12-06 14:30:00 +0100
...
1. Since you can no longer download extensions from Visual Studio Marketplace directly, use this [github copilot download][copilot-download] link. It pulls the latest version. You'll get a file ending with `.vsix`.
...
The 3rd step will not be needed in the future when the proposed changes to the Code OSS api will be merged.

[copilot-download]: https://github.gallery.vsassets.io/_apis/public/gallery/publisher/GitHub/extension/copilot/latest/assetbyname/Microsoft.VisualStudio.Services.VSIXPackage
